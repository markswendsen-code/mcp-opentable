...
import { checkAuth, getLoginUrl, searchRestaurants, getRestaurantDetails, checkAvailability, makeReservation, getReservations, cancelReservation, cleanup, } from "./browser.js";
    ...
    return {
        tools: [
            ...
            },
            {
                ...
                description: "Get the OpenTable login URL and instructions for the user to authenticate. Use this when opentable_status returns not logged in.",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
            ...
            },
            {
                ...
                description: "Check available reservation time slots for a restaurant on a specific date and party size.",
                inputSchema: {
                    type: "object",
                    properties: {
                        restaurantId: {
            ...
            },
            {
                ...
                description: "List all upcoming reservations for the logged-in user. Requires authentication.",
                inputSchema: {
                    type: "object",
                    properties: {},
                },
            },
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        reservationId: {
                            type: "string",
                            description: "The reservation ID to cancel (from opentable_get_reservations)",
                        },
                        confirm: {
                            type: "boolean",
